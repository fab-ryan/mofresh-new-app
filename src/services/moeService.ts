...
const MOE_KNOWLEDGE_BASE: MoeIntents[] = [
  {
    ...
    response:
      "My name MOE stands for 'DD Harvest Official Expert'! I'm your animated sprout buddy here to help you navigate DD Harvest. 🌿",
  },
  {
    keywords: [
      "marketplace",
    ...
    response:
      "You can explore our marketplace to buy fresh produce directly from farmers or sell your own! 🍎",
  ...
  },
  {
    ...
    response:
      "I'll take you to your personal dashboard where you can see all your activities. 📊",
    navigate: "/dashboard",
  },
  // ADMIN ROUTES
  {
    ...
    response:
      "Accessing the Admin Control Center. Here you can manage users, sites, and assets globally. 🔐",
  ...
  },
  {
    ...
    response:
      "Opening User Management. You can manage roles and account statuses here. 👥",
  ...
  },
  {
    ...
    response:
      "Opening Site Management. Here you can manage all DD Harvest Cold Hubs globally. 🏗️",
  ...
  },
  {
    ...
    response:
      "Opening Asset Management. Track your DD Harvest Boxes and solar units here. 📦",
  ...
  },
  {
    ...
    response:
      "Opening Product Management. Update prices and stock for the marketplace. 🥦",
  ...
  // MANAGER ROUTES
  {
    ...
    response:
      "Navigating to the Site Manager dashboard for hub operations and inventory control. 🏗️",
  ...
  },
  {
    ...
    response:
      "Viewing the Hub Inventory. Check what is currently stored in the cold room. ❄️",
  ...
  },
  {
    ...
    response:
      "Opening Asset Control. Monitor temperature and solar power status. ⚡",
  ...
  // BUYER ROUTES
  {
    ...
    response:
      "Opening the Buyer Dashboard. Here you can track your orders and rentals. 🛍️",
  ...
  // SUPPLIER ROUTES
  {
    ...
    response:
      "Opening the Supplier Dashboard. Here you can manage your inventory and sales. 💰",
  ...
  // COMMON
  {
    ...
    response:
      "You can view your financial reports, sales history, and pending payments in the Reports section of your dashboard. 💰",
  ...
  },
  {
    ...
    response:
      "Our solar-powered hubs provide affordable cold storage to keep your produce fresh. We are in Kigali, Musanze, Rubavu, and Huye! ❄️",
  ...
  },
  {
    ...
    response:
      "DD Harvest Boxes are portable, insulated containers that keep produce cool during transport. Perfect for small deliveries! 📦",
  },
  {
    keywords: [
      "profile",
    ...
    response:
      "You can update your personal information and settings in your profile page. 👤",
    navigate: "/profile",
  },
  {
    keywords: [
    ...
    response:
      "Need more help? You can reach our support team through the Contact page or call us at +250 788 526 631! 📞",
    navigate: "/contact",
  },
  {
    keywords: [
  ...
  },
  {
    ...
    response:
      "DD Harvest (by KIVU Cold Group) is building Africa's first digital cold chain. MOE is the 'DD Harvest Official Expert'! 🌍",
    navigate: "/about",
  },
  {
    keywords: [
    ...
    response:
      "You can manage your session here. Don't forget to come back soon! 🚪",
    navigate: "/login",
  },
];
...
const getApiKey = () => {
  ...
  if (!key || key === "your_actual_api_key_here") {
    console.error(
      "Moe Error: VITE_GOOGLE_AI_KEY is missing or invalid in .env",
    );
    return null;
  }
  return key;
...
You are "Moe", the animated sprout assistant for DD Harvest (by KIVU Cold Group Ltd) in Rwanda. 
...
Your name "Moe" stands for "DD Harvest Official Expert".
...
export const getMoeResponse = async (message: string): Promise<string> => {
  ...
  try {
    ...
    if (
      input.includes("muraho") ||
      input.includes("amakuru") ||
      input.includes("mumeze")
    ) {
    ...
    if (input.includes("DD Harvest") || input.includes("iki")) {
      return "DD Harvest ni uburyo bufasha abahinzi kubika umusaruro wabo neza mu bubiko bukonjesha (Cold Storage) no kuwugurisha ku isoko rigezweho. 🌍";
    }
