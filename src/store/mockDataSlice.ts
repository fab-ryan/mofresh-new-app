...
const initialState: MockDataState = {
  users: [
    ...
    },
    {
      ...
      firstName: "Jane",
      lastName: "Uwimana",
      email: "jane@DD Harvest.rw",
      role: "SITE_MANAGER",
      status: "ACTIVE",
      siteId: "s1",
      location: "Kigali Central Hub",
    ...
    },
    {
      ...
      firstName: "Manager",
      lastName: "Musanze",
      email: "musanze@DD Harvest.rw",
      role: "SITE_MANAGER",
      status: "ACTIVE",
      siteId: "s2",
      location: "Musanze Northern Hub",
      joinedDate: "2025-02-15",
    },
    {
      id: "u6",
      firstName: "Manager",
      lastName: "Rubavu",
      email: "rubavu@DD Harvest.rw",
      role: "SITE_MANAGER",
      status: "ACTIVE",
      siteId: "s3",
      location: "Rubavu Western Hub",
    ...
    },
    {
      ...
      firstName: "Manager",
      lastName: "Huye",
      email: "huye@DD Harvest.rw",
      role: "SITE_MANAGER",
      status: "ACTIVE",
      siteId: "s4",
      location: "Huye Southern Hub",
  ...
  categories: [
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1566385101042-1a000451b501?w=400",
    },
    {
      id: "c2",
      name: "Fruits",
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1610832958506-ee563384239d?w=400",
    },
    {
      id: "c3",
      name: "Dairy",
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1550583724-1255d14266a2?w=400",
    },
  ],
  products: [
    {
    ...
    },
    {
      ...
      room: "Room A1",
      imageUrl:
        "https://images.unsplash.com/photo-1580149405543-33bc45002f61?w=400",
    },
    {
      id: "p3",
      name: "Avocados",
    ...
    },
    {
      ...
      room: "Room C3",
      imageUrl:
        "https://images.unsplash.com/photo-1563636619-e910ef2a844b?auto=format&fit=crop&q=80&w=200",
    },
  ],
  movements: [],
  transactions: [
    {
      ...
      type: "SALE",
      date: "2025-02-18",
      items: ["Fresh Tomatoes", "Organic Onions"],
      siteId: "s1",
  ...
  reducers: {
    ...
    updateUser: (state, action: PayloadAction<MockUser>) => {
      const index = state.users.findIndex(
        (u: MockUser) => u.id === action.payload.id,
      );
      if (index !== -1) state.users[index] = action.payload;
    },
    deleteUser: (state, action: PayloadAction<string>) => {
      state.users = state.users.filter(
        (u: MockUser) => u.id !== action.payload,
      );
    },
    ...
    updateAsset: (state, action: PayloadAction<MockAsset>) => {
      const index = state.assets.findIndex(
        (a: MockAsset) => a.id === action.payload.id,
      );
      if (index !== -1) state.assets[index] = action.payload;
    },
    deleteAsset: (state, action: PayloadAction<string>) => {
      state.assets = state.assets.filter(
        (a: MockAsset) => a.id !== action.payload,
      );
    },
    ...
    updateCategory: (state, action: PayloadAction<MockCategory>) => {
      const index = state.categories.findIndex(
        (c: MockCategory) => c.id === action.payload.id,
      );
      if (index !== -1) state.categories[index] = action.payload;
    },
    deleteCategory: (state, action: PayloadAction<string>) => {
      state.categories = state.categories.filter(
        (c: MockCategory) => c.id !== action.payload,
      );
    },
    ...
    updateProduct: (state, action: PayloadAction<MockProduct>) => {
      const index = state.products.findIndex(
        (p: MockProduct) => p.id === action.payload.id,
      );
      if (index !== -1) state.products[index] = action.payload;
    },
    deleteProduct: (state, action: PayloadAction<string>) => {
      state.products = state.products.filter(
        (p: MockProduct) => p.id !== action.payload,
      );
    },
    ...
    verifyTransaction: (state, action: PayloadAction<string>) => {
      const index = state.transactions.findIndex(
        (t: MockTransaction) => t.id === action.payload,
      );
    ...
    updateTransactionStatus: (
      ...
      const index = state.transactions.findIndex(
        (t: MockTransaction) => t.id === action.payload.id,
      );
      if (index !== -1)
    ...
    approveSupplierRequest: (state, action: PayloadAction<string>) => {
      const reqIndex = state.supplierRequests.findIndex(
        (r: MockSupplierRequest) => r.id === action.payload,
      );
      if (reqIndex !== -1) {
        ...
        const newUser: MockUser = {
          ...
          status: "ACTIVE",
          location:
            state.sites.find((s: MockSite) => s.id === req.targetBranch)
              ?.name || "Central Hub",
    ...
    rejectSupplierRequest: (state, action: PayloadAction<string>) => {
      const index = state.supplierRequests.findIndex(
        (r: MockSupplierRequest) => r.id === action.payload,
      );
