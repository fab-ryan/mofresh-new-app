        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-10">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
              {selectedSiteId === 'ALL'
                ? t('showingProductsAllSites', 'Showing fresh products from all DD Harvest hubs')
          ...
          <div className="flex flex-wrap gap-2 items-center">
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-black uppercase tracking-widest border ${selectedSiteId === 'ALL'
            ...
            {sites.map(site => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-black uppercase tracking-widest border ${selectedSiteId === site.id
                  ? 'bg-[#2d6a4f] text-white border-[#2d6a4f]'
                  : 'bg-white text-gray-700 border-gray-200 dark:bg-gray-800 dark:text-gray-200'
                  }`}
              >
          ...
          <div className="relative z-20 grid grid-cols-1 lg:grid-cols-10 items-center gap-0">
            ...
            <div className="lg:col-span-4 text-center space-y-8 py-12 px-6">
              <div className="inline-block px-5 py-2 rounded-full bg-[#2E8B2E]/10 border border-[#2E8B2E]/20">
                <span className="text-[#2E8B2E] text-sm font-black tracking-widest uppercase">DD Harvest Online</span>
              </div>
