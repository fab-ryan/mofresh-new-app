          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-1 flex flex-col items-center sm:items-start">
            <Link to="/" className="inline-block mb-4">
              <div className="rounded-xl inline-block">
                <img src={Logo} alt="DD Harvest Logo" className="h-8 w-auto" />
              </div>
            </Link>
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/DD Harvestrw/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center hover:bg-[#9be15d] hover:text-[#0B3D2E] transition-all border border-white/10 hover:border-[#9be15d]">
