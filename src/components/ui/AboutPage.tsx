...
function AboutPage() {
  ...
  const products = [
    {
      icon: Sun,
      title: t('HarvestHubLabel'),
      description: t('HarvestHubDesc')
    },
    {
      icon: Package,
      title: t('HarvestBoxLabel'),
      description: t('HarvestBoxDesc')
    },
    {
      icon: Smartphone,
      title: t('HarvestAppLabel'),
      description: t('HarvestAppDesc')
    }
  ];
