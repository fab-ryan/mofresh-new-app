...
export const ContactPage = () => {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    // EmailJS Logic - Sends to info@DD Harvest.rw
    emailjs.sendForm(
      'YOUR_SERVICE_ID',
      'YOUR_TEMPLATE_ID',
      form.current!,
      ...
      <section className="w-full max-w-[1728px] mx-auto px-4 sm:px-8 lg:px-16 py-6 lg:py-8">
        <div className="relative rounded-[40px] lg:rounded-[56px] overflow-hidden bg-[#2d6a4f] py-20 lg:py-32 border border-white/10">
          ...
          <div className="relative z-10 text-center px-6">
            ...
            >
              {t('connectWith')} <br />
              <span className="text-[#9be15d] italic">{t('HarvestDot')}</span>
            </motion.h1>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div className="space-y-6">
              {[
                { icon: MapPin, title: t('addressLabel'), detail: "KG 652 St Kigali, Rwanda", sub: t('HarvestHub') },
                { icon: Mail, title: t('emailLabel'), detail: "info@mofresh.rw", sub: t('primarySupport') },
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      type="email"
                      required
                      placeholder="info@DD Harvest.rw"
                      className="w-full px-8 py-5 rounded-[24px] bg-gray-50 dark:bg-gray-900 border-none focus:ring-2 focus:ring-[#9be15d] outline-none dark:text-white"
                    />
                  </div>
                </div>
                ...
                >
                  {status === 'sending' ? (
                    ...
                    <><CheckCircle size={22} /> {t('sentToDD Harvest')}</>
                  ) : (
      ...
      <section className="w-full max-w-[1728px] mx-auto px-4 sm:px-8 lg:px-16 pb-24">
        <div className="relative h-[600px] w-full rounded-[56px] overflow-hidden border-8 border-white dark:border-gray-800">
          <iframe
            ...
            style={{ border: 0 }}
            loading="lazy"
            title="DD Harvest Location"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3987.452601957262!2d30.101784!3d-1.972989!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19dca7807c788045%3A0xbb7b58ae4db33e29!2sDD Harvest%20OFF-GRID%20Cold%20Storage%20HUB!5e0!3m2!1sen!2srw!4v1700000000000!5m2!1sen!2srw"
          ></iframe>
          ...
          <div className="absolute bottom-10 left-10 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md p-6 rounded-3xl hidden md:block border border-white/20">
            <p className="text-[#2d6a4f] font-black text-xl mb-1">{t('DD HarvestHub')}</p>
            <p className="text-gray-500 text-sm font-bold">{t('DD HarvestAddress')}</p>
          </div>
        </div>
      </section>
    </div>
