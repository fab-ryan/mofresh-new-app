          ...
          <div className="relative z-10 px-8 lg:px-24 max-w-5xl">
            ...
            >
              ...
              <nav className="flex items-center gap-3 text-white/50 font-bold pt-4 text-sm uppercase tracking-widest">
                ...
                <span className="text-white">About DD Harvest</span>
              </nav>
            </motion.div>
          </div>
        </div>
          ...
          <div className="lg:col-span-6 space-y-10">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed mb-10">
                DD Harvest is an integrated cold chain and agricultural marketplace platform designed to empower small-scale farmers in Rwanda by eliminating post-harvest losses.
              </p>
